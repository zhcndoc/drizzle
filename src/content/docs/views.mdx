...
根据官方文档，PostgreSQL 和 CockroachDB 具有 **[`常规`](https://www.postgresql.org/docs/current/sql-createview.html)**
和 **[`物化`](https://www.postgresql.org/docs/current/sql-creatematerializedview.html)** 视图。
  
PostgreSQL 和 CockroachDB 中的物化视图像视图一样使用规则系统，但以表格形式持久化结果。
