...
> 查看新的 RQBv2 schema 文档：https://orm.drizzle.team/docs/relations

> 查看新的 RQBv2 查询文档：https://orm.drizzle.team/docs/rqb
...
- [blob](/docs/mysql/column-types#blob)
- [tinyblob](/docs/mysql/column-types#tinyblob)
- [mediumblob](/docs/mysql/column-types#mediumblob)
- [longblob](/docs/mysql/column-types#longblob)
...
- [[BUG]: Drizzle-kit 将 Postgres 函数提取为 TypeScript 方法](https://github.com/drizzle-team/drizzle-orm/issues/4916)
