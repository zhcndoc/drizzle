...
## Why not choose SQL-like?
We always strive for a perfectly balanced solution. Although SQL-like can cover 100% of the requirements,
in some common scenarios, you can query data better.  

We have built the **[Query API](/docs/rqb)** for you, which extracts relational nested data from the database in the most convenient and efficient way,
without having to worry about joins and data mapping.  

**Drizzle always outputs exactly 1 SQL query.** Use it with confidence alongside serverless databases, never worrying about performance or round-trip costs!
...
Drizzle 通过行业标准的数据库驱动程序原生运行。我们支持所有主流的 **[PostgreSQL](/docs/get-started-postgresql)**、**[MySQL](/docs/mysql/get-started-mysql)** 或 **[SQLite](/docs/sqlite/get-started-sqlite)** 驱动程序，并且我们正在 **[非常快速地](https://twitter.com/DrizzleORM/status/1653082492742647811?s=20)** 添加新的驱动程序。  
...
现在就用 Drizzle 和你的 **[PostgreSQL](/docs/get-started-postgresql)**、**[MySQL](/docs/mysql/get-started-mysql)** 或 **[SQLite](/docs/sqlite/get-started-sqlite)** 数据库开始构建一些很棒的东西吧。🚀
