...
<Prerequisites>
  ...
  - **Vercel Postgres 数据库** - [在这里阅读](https://vercel.com/docs/storage/vercel-postgres)
  - **Vercel Postgres 驱动** - [在这里阅读](https://vercel.com/docs/storage/vercel-postgres/sdk) & [GitHub](https://github.com/vercel/storage/tree/main/packages/postgres)
</Prerequisites>
