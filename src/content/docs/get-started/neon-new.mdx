...
<Prerequisites>
  - **dotenv** - 用于管理环境变量的包 - [点此阅读](https://www.npmjs.com/package/dotenv)
  - **tsx** - 用于运行 TypeScript 文件的包 - [点此阅读](https://tsx.hirok.io/)
  - **Neon** - 无服务器 Postgres 平台 - [点此阅读](https://neon.tech/docs/introduction)
</Prerequisites>
