...
<Prerequisites>
  ...
  - **tsx** - 用于运行 TypeScript 文件的包 - [read here](https://tsx.hirok.io/)
  - Turso 数据库 - [website](https://docs.turso.tech/introduction)
  - Turso 数据库驱动 - [website](https://docs.turso.tech/connect/javascript) & [GitHub](https://github.com/tursodatabase/turso/tree/main/bindings/javascript)
</Prerequisites>
