...
<Prerequisites>
  ...
  - **Vercel Postgres database** - [在此阅读](https://vercel.com/docs/storage/vercel-postgres)
  - **Vercel Postgres driver** - [在此阅读](https://vercel.com/docs/storage/vercel-postgres/sdk) & [GitHub](https://github.com/vercel/storage/tree/main/packages/postgres)
</Prerequisites>
