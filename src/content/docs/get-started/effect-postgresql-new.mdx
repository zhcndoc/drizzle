...
<Prerequisites>
  - **Effect** - Effect 是一个强大的 TS 库，旨在帮助开发者轻松创建复杂的同步和异步程序。- [了解更多](https://effect.website/docs)
  - **dotenv** - 用于管理环境变量的包 - [查看这里](https://www.npmjs.com/package/dotenv)
  - **tsx** - 用于运行 TypeScript 文件的包 - [查看这里](https://tsx.hirok.io/)
  - **@effect/sql-pg** - 一个适用于 Effect 的 PostgreSQL 工具包 - [查看这里](https://effect-ts.github.io/effect/docs/sql-pg)
</Prerequisites>
...
<Callout title='技巧'>
如果你还没有 PostgreSQL 数据库，并且想创建一个用于测试的数据库，可以参考我们的 PostgreSQL Docker 安装指南。
