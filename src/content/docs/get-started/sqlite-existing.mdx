...
<Prerequisites>  
  - **dotenv** - 用于管理环境变量的软件包 - [在此阅读](https://www.npmjs.com/package/dotenv)
  - **tsx** - 用于运行 TypeScript 文件的软件包 - [在此阅读](https://tsx.hirok.io/)
  - **libsql** - SQLite 的一个分支，针对较低的查询延迟进行了优化，因此适用于全球应用程序 - [在此阅读](https://docs.turso.tech/libsql)
</Prerequisites>
