...
<Prerequisites>
  ...
  - **SQLite Cloud 数据库** - [在此阅读](https://docs.sqlitecloud.io/docs/overview)
  - **SQLite Cloud 驱动** - [在此阅读](https://docs.sqlitecloud.io/docs/sdk-js-introduction) & [GitHub](https://github.com/sqlitecloud/sqlitecloud-js)
</Prerequisites>
