...
<Prerequisites>
  ...
  - **Cloudflare D1** - 无服务器 SQL 数据库，可用于在你的 Workers 和 Pages 项目中进行查询 - [在这里阅读](https://developers.cloudflare.com/d1/)
  - **wrangler** - Cloudflare Developer Platform 命令行接口 - [在这里阅读](https://developers.cloudflare.com/workers/wrangler)
</Prerequisites>
