...
**[自动迁移](/docs/migrations)** 和 **[另一项](/docs/rqb)**。✨
...
## Why not SQL-like?
We are always pursuing a perfectly balanced solution. Although SQL-like 100% meets the requirements,  
in some common scenarios, you can query data more effectively.

We built the **[Query API](/docs/rqb)** for you, so you can retrieve relational nested data from the database in the most convenient and efficient way,
without having to think about joins and data mapping.

**Drizzle always outputs exactly 1 SQL query.** You can safely use it with serverless databases without worrying about performance or round-trip costs!
...
Drizzle 通过业界标准的数据库驱动程序原生运行。我们支持所有主流的 **[PostgreSQL](/docs/get-started-postgresql)**、**[MySQL](/docs/mysql/get-started-mysql)**、**[SQLite](/docs/sqlite/get-started-sqlite)** 或 **[SingleStore](/docs/singlestore/get-started-singlestore)** 驱动，并且我们还在 **[非常快速](https://twitter.com/DrizzleORM/status/1653082492742647811?s=20)** 地添加新的支持。  
...
我们有一个很棒的 **[Discord 社区](https://driz.link/discord)**，并欢迎所有构建者加入我们的 **[Twitter](https://twitter.com/drizzleorm)**。
  
现在去用 Drizzle 和你的 **[PostgreSQL](/docs/get-started-postgresql)**、**[MySQL](/docs/mysql/get-started-mysql)** 或 **[SQLite](/docs/sqlite/get-started-sqlite)** 数据库构建一些令人惊叹的东西吧。🚀

现在去用 Drizzle 和你的 **[PostgreSQL](/docs/get-started-postgresql)**、**[MySQL](/docs/mysql/get-started-mysql)** 或 **[SQLite](/docs/get-started-sqlite)** 数据库构建一些令人惊叹的东西吧。🚀
