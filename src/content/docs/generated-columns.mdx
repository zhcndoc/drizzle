...
<Tabs items={["PostgreSQL", "MySQL", "SQLite", "SingleStore(WIP)", "MSSQL", "CockroachDB"]}>
  <Tab>
    ...
    **限制**
    ...
    <Callout type='warning' collapsed="从 1.0.0-beta.12 版本开始的更改">
  ...
  <Tab>
    ...
    **工作原理**
    ...
    欲了解更多信息，请参阅 [MSSQL](https://learn.microsoft.com/en-us/sql/relational-databases/tables/specify-computed-columns-in-a-table?view=sql-server-ver17) 文档
