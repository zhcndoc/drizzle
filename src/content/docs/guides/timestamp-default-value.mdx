...
<Prerequisites>
- 开始使用 [PostgreSQL](/docs/get-started-postgresql)、[MySQL](/docs/mysql/get-started-mysql) 和 [SQLite](/docs/sqlite/get-started-sqlite)
- 了解 [PostgreSQL](/docs/column-types)、[MySQL](/docs/mysql/column-types) 和 [SQLite](/docs/sqlite/column-types) 的列数据类型
- [sql 操作符](/docs/sql)
</Prerequisites>
