...
```
- 您可以 [refine](/docs/guides/seeding-with-partially-exposed-schema#refining-the-userid-column-generator) `userId` 列生成器；
...
- 另外，您可以 [细化](/docs/guides/seeding-with-partially-exposed-schema#refining-the-userid-column-generator) `userId` 列生成器。 
