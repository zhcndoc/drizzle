...
<Prerequisites>
- 使用 Drizzle 的数据库 [连接基础](/docs/sqlite/connect-overview)
- **Cloudflare SQLite Durable Objects** - 嵌入在 Durable Object 中的 SQLite 数据库 - [在此阅读](https://developers.cloudflare.com/durable-objects/best-practices/access-durable-objects-storage/#sqlite-storage-backend)
</Prerequisites>
