...
你可以将 [Drizzle Studio](/docs/drizzle-studio/overview) 与你的应用一起部署到 Railway 上，直接从浏览器浏览和管理数据库。你可以使用 [Drizzle Studio Railway 模板](https://railway.com/deploy/drizzle-studio-1)，或者按照下面的步骤操作。
