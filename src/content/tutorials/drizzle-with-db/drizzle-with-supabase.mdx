...
了解有关[迁移过程](https://orm.drizzle.team/docs/migrations)的更多信息。您还可以使用 [Supabase CLI](https://supabase.com/docs/guides/cli/getting-started) 应用迁移：

要使用 Supabase CLI 应用迁移，请初始化本地 Supabase 项目，将其链接到您的远程项目，并将更改推送到数据库：
