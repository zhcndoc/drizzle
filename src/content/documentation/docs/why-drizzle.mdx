...
Drizzle 通过行业标准的数据库驱动程序原生操作。我们支持所有主要的 **[PostgreSQL](/docs/get-started-postgresql)**、**[MySQL](/docs/get-started-mysql)** 或 **[SQLite](/docs/get-started-sqlite)** 驱动程序，并且我们新增支持 **[速度很快](https://twitter.com/DrizzleORM/status/1653082492742647811?s=20)**。  
