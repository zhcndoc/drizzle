...
Drizzle 通过行业标准数据库驱动程序原生运行。我们支持所有主要的 **[PostgreSQL](/docs/get-started-postgresql)**、**[MySQL](/docs/get-started-mysql)** 或 **[SQLite](/docs/get-started-sqlite)** 驱动程序，并且我们正在 **[很快] 添加新驱动](https://twitter.com/DrizzleORM/status/1653082492742647811?s=20)**。
